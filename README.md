...
![OWASP ZAP](https://img.shields.io/badge/OWASP%20ZAP-green?style=for-the-badge)
...
- **ISC2 – CC (Certified in Cybersecurity)** (Jan 2026)  
- **Security Operations Center (SOC)** – Cisco Networking Academy (Dec 2025)  
- **Incident Response & Digital Forensics** – IBM (Dec 2025)  
- **Penetration Testing, Threat Hunting & Cryptography** – IBM (Dec 2025)  
- **Security Analyst Fundamentals** – IBM (Dec 2025)  
- **MITRE ATT&CK v13 Foundations** – AttackIQ (Dec 2025)  
- **Foundations of Purple Teaming** – AttackIQ (Dec 2025)  
